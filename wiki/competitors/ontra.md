...
- **Mature side-letter / MFN tracking** — the primary reason Anduin loses these deals (Ottawa Capital, Pomona Capital both cited side-letter obligation tracking). Used by Anduin customers for side letters/MFN (Madison International).
- **AI search + provision sorting** (Insight / GPT-4) for fundraising and compliance workflows.
- **More evolved UI** than law-firm-oriented rivals.

**Where Anduin wins / Ontra is weak:**
- **Law-firm collaboration** — Ontra is perceived as **competitive and onerous** toward law firms and assumes GPs want to handle MFNs in-house. Pro-Vision and Paul Weiss prefer rivals that support the outsource-to-law-firm model and offer cross-client visibility (Ontra lacks cross-client visibility for law firms).
- Anduin's opportunity is the broader onboarding platform; side letters are an attach/defend motion.
...
## Win/loss
- **Lost to Ontra:** Ottawa Capital, Pomona Capital — both on side-letter obligation tracking in-platform.
