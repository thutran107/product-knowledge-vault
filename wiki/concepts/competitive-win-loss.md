---
type: concept
title: "Competitive Win/Loss Patterns"
source_count: 1
confidence: medium
...
## Definition
Recurring reasons Anduin **wins** and **loses** competitive deals, synthesized from logged win/loss intel. Use to anticipate objections and pick the right battleground.
...
## Evidence & examples
- **Hamilton Lane (lost, 2022):** functionality/pricing similar, Passthrough won on **LP UI** ("TurboTax of private markets").
- **NYCA (lost):** Passthrough $18K one-time vs Anduin $61.5K itemized — non-recurring fee was the sticking point.
- **Lattice Capital (won):** chose Anduin for sleek UI + SSO though Passthrough was cheaper.
- **2150 VC (won/renewal):** difficult renewal — Goodwin advocated for Passthrough.
- **S32 (won, $30K):** champion advocacy internally.
- **Subscribe losses (GTIS, HPS, Adam's Street):** LP Profile + API capability gaps.

## Tensions & open questions
- Price losses cluster at emerging/mid tier; relationship/maturity wins cluster at whale/enterprise — implies tier-specific playbooks.
