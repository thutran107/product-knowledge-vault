---
type: concept
title: "Private Markets Competitive Landscape"
source_count: 1
confidence: medium
...
## Evidence & examples (general/market intel, no single competitor)
- **RIA roll-ups** *(Nov 2024)* — PE firms (incl. Anduin customers CDR, Stone Point) acquire RIAs into "roll-ups," improve them with tech, and resell. **Network-effect opportunity:** when Anduin has RIA products, PE customers are incentivized to promote them to portfolio RIAs.
- **RIA/wealth demand** *(2023)* — strong demand for VC access from RIAs & family offices (Allocate onboards many advisors); GP supply is the bottleneck (Allocate talks to 500–700 GPs/yr, adds only 20–30).
- **Secondary markets booming** *(Oct 2024)*.
- **Sydecar Fund+** *(2023)* — "launch a fund and accept commitments in <1 week" (emerging-manager speed play).
- **Farther** *(2023)* — RIA model (advisers as employees + tech + revenue share); offered to guide an Anduin RIA product.
- **Revolution Funds** — side-letter intel (Gong call).

## Tensions & open questions
- Should Anduin build **LP-facing / AI / marketplace** products, or defend the GP onboarding core? The intel leans toward "build LP-side to stay sticky."
