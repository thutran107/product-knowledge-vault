...
*Source: [[sources/fundsub-essentials-sales-deck|Essentials Sales Deck]] (Jun 2025). No explicit pricing figures available — contact Sales for commercial terms.*
...
- Theme customization: configured in iTools at the environment level (see [[sources/fundsub-dataroom-theme-customization|Theme Customization Guide]]). Requires gathering brand color HEX values from the customer.
- Duplicate fund: allows GP to spin up a new fund from an existing fund's configuration (see [[sources/fundsub-duplicate-fund-config|Duplicate Fund Config Guide]]).
- Email/SMTP: custom email configuration available per CS setup (see [[sources/fundsub-email-smtp-implementation-guide|Email & SMTP Guide]]).
...
- [[products/e-signature|E-signature]] — signing workflow embedded within FundSub
- Theme customization (see [[sources/fundsub-dataroom-theme-customization|Theme Customization Guide]])

## Related customers
- [[customers/neuberger-berman|Neuberger Berman]] — ~3,000 LPs, $5.4B raised via FundSub + IH
- [[customers/cerity-partners|Cerity Partners]] — FundSub + AAA + E-signature (Schwab DocuSign workflow)
- [[customers/nxstep|NXSTEP]] — Essentials tier; quote highlights 3x manual process efficiency gain

## Sources
- [[sources/fundsub-essentials-sales-deck|FundSub Anduin Essentials Sales Deck]] (Jun 2025, onboarding required)
- [[sources/fundsub-new-lp-view-one-pager|New LP View One-Pager]] (Dec 2025)
- [[sources/fundsub-email-smtp-implementation-guide|Email Configuration & SMTP Implementation Guide]] (Mar 2025)
- [[sources/fundsub-duplicate-fund-config|Duplicate Fund Configuration Guide]] (Nov 2025)
- [[sources/fundsub-one-envelope-experience|One Envelope Experience]] (Mar 2025)
- [[sources/fundsub-dataroom-theme-customization|Theme Customization — Internal Guide]] (Sep 2025)
...
- [[sources/automated-document-repository|Box Document Retrieval]]
- [[sources/data-management|Data Management]]
...
- [[products/data-room|Data Room]] — shares theme customization feature
...
- [[sources/fundsub-investor-email-support]] — investor-initiated support email feature (Sep 2025)
- [[sources/fundsub-primary-vs-collaborator]] — Primary vs. Collaborator distinction in orders
