...
- **Assign/unassign subscriptions**: GPs can assign or unassign any subscription — created directly in FundSub, via CRM, or via IDM — to/from advisor entities (released Oct 2025; see [[sources/aaa-advisor-subscription-assign|release note]]).
...
- **Auto-fill onboarding**: advisors prefill subscription docs from past subscriptions or from an [[products/investor-access|Investor Access]] passport, and reuse pre-saved AML/KYC documents.
...
## Permission model
Two tiers (see [[sources/aaa-sales-deck|Sales Deck]] and [[sources/aaa-cs-training|CS Training]]):
...
- Full how-to articles published on HelpJuice (`support.anduintransact.com/en_US/advisor-advantage`); see [[sources/aaa-user-guide|AAA User Guide]].
...
Capabilities are documented inline above. AAA is delivered through [[products/fundsub|FundSub]] (GP side) and the standalone Advisor Advantage app (advisor side); signature features overlap with [[products/e-signature|E-signature]].

## Related customers
- [[customers/cerity-partners|Cerity Partners]] — uses AAA + FundSub + E-signature (Schwab DocuSign workflow).

## Sources
- [[sources/aaa-product-brief|AAA Product Brief]] (RIA brief, 2024) — who RIAs are and the business case.
- [[sources/aaa-sales-deck|AAA Sales Deck (Demo Screens)]] (Jan 2026) — capabilities + permission model.
- [[sources/aaa-gtm-training|AAA GTM Training]] (Nov 2024) — GTM motion, roadmap, pricing posture.
- [[sources/aaa-cs-training|AAA CS Demo + Training]] (Jan 2026) — setup, data model, troubleshooting.
- [[sources/aaa-user-guide|AAA User Guide]] (HelpJuice index) — end-user how-to articles.
- [[sources/aaa-advisor-tags|AAA Advisor Tags]] (2025) — GP→advisor tag communication.
- [[sources/aaa-advisor-subscription-assign|Assign/Unassign Subscriptions to Advisor Entities]] (Oct 2025).

## Related
- [[products/fundsub|FundSub]] — AAA's GP-side workflow lives here.
- [[products/investor-access|Investor Access]] — LP passport advisors use for auto-fill.
- [[products/e-signature|E-signature]] — one-envelope & Schwab custodian signing.
- [[products/investor-data-management|IDM]] — fund-side data management (GP-side counterpart context).
